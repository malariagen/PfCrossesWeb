...
define(["require", "DQX/Framework", "DQX/Controls", "DQX/PopupFrame", "DQX/Msg", "DQX/DocEl",
    ...
    "DQX/ChannelPlot/ChannelSnps2", "DQX/DataFetcher/DataFetcherFile", "Page", "CrossesMetaData"],
    function (require, Framework, Controls, PopupFrame, Msg, DocEl, DQX, FrameList,
              ChannelSnps, DataFetcherFile, Page, CrossesMetaData) {
        ...
        var SnpCallPopupModule = {
            ...
            create : function(snpInfo,seqID,chrom) {
                var that=this;
                var popup = PopupFrame.PopupFrame('LookseqPopupFrame', Framework.FrameFinal('LookseqPic'), { title: seqID.replace(/__/g, '/') + snpInfo.position, sizeX: 830, sizeY: 800 });
